# Author: Toby Chen
# Created: 2025-02-24
# Desctiption: This file contains the encoder class for the TLV codec.
...
class Encoder:
    def __init__(self, deviceId, bufferSize=1024, crc=True):
        ...
        self.frameHeader.numTotalBytes = ctypes.sizeof(self.frameHeader)
    ...
    def addPacket(self, type, length, value):
        ...
        index = self.frameHeader.numTotalBytes
        ...
        self.frameHeader.numTotalBytes += length2add
        ...
        print( 'num total bytes: ', self.frameHeader.numTotalBytes)
    ...
    def wrapupBuffer(self, deviceId=None, frameNum=None):
        ...
        index = self.frameHeader.numTotalBytes
        length2add = NUM_PADDING_BYTES(self.frameHeader.numTotalBytes)
        ...
        if (self.crc == True):
            ...
            crc32 = binascii.crc32(self.buffer[16:self.frameHeader.numTotalBytes])
            self.frameHeader.checksum = crc32
        else:
            # if crc is not enabled, set the crc to 0
        ...
        return self.frameHeader.numTotalBytes, self.buffer
